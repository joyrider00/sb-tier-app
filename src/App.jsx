  ...
  return (
    <div style={{
      ...
      >
        ...
        <svg width="80" height="31" viewBox="0 0 69 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div style={{ fontSize: 8, color: "rgba(255,255,255,0.25)", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.3, textAlign: "center", maxWidth: 160 }}>
